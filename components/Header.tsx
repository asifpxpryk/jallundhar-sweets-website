    ...
    <header className="sticky top-0 z-40 border-b border-gold-200 bg-cream/95 backdrop-blur">
      ...
      <div className="relative mx-auto flex max-w-6xl items-center px-4 py-3 sm:px-6">
        ...
        <div className="ml-auto flex flex-shrink-0 items-center gap-2">
          <button
            onClick={open}
            className="relative flex h-11 items-center gap-2 rounded-full bg-maroon-700 px-3 text-sm font-semibold text-white shadow-sm transition hover:bg-maroon-800 sm:px-4"
          >
          ...
          <Link
            href="/account"
            aria-label="Account"
            className="hidden h-11 w-11 items-center justify-center rounded-full border border-gold-300 text-maroon-700 xl:flex"
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
