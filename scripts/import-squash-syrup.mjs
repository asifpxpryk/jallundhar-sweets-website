...
const CATEGORY_ID = "328";
const AISLE_KEY = "beverage:squash-syrup";
const FILE_PREFIX = "squash-syrup";
...
function isAllowedBrand(name) {
  ...
  return n.includes("qarshi") || n.includes("mitchell");
}
